...
const SUBSECTIONS = {
  ...
  'The AI MBA': [
    { label: 'Track 0 · Promote', blurb: 'The reframe: AI didn’t replace you — it promoted you.',
      slugs: ['the-promotion', 'the-decision-stack', 'the-executive-operating-system'] },
    { label: 'Track 1 · Launch', blurb: 'From expertise to a first paid offer in a weekend.',
      slugs: ['document-your-expertise', 'your-first-ai-powered-offer', 'marketing-assets-in-a-weekend'] },
    { label: 'Track 2 · Operate', blurb: 'Get the work off your plate and deliver at scale.',
      slugs: ['stop-doing-everything-yourself', 'client-delivery-at-scale', 'content-that-runs-without-you'] },
    { label: 'Track 3 · Compound', blurb: 'Think like a strategist; build assets that sell while you sleep.',
      slugs: ['think-like-a-strategist', 'build-once-sell-forever', 'the-one-person-empire'] },
    { label: 'Track 4 · Multiply — the People path', blurb: 'Lead a team that multiplies, instead of a team you replace.',
      slugs: ['transform-mindset-and-roles', 'augment-your-team-with-ai', 'optimize-for-impact'] },
    { label: 'Track 4 · Produce — the Content path', blurb: 'The fork: a content engine instead of a people org.',
      slugs: ['the-content-production-system', 'video-that-sells', 'the-one-person-studio'] },
    { label: 'Track 5 · Publish', blurb: 'Turn what you know into books and knowledge products.',
      slugs: ['the-book-you-already-wrote', 'the-knowledge-product', 'the-publishing-business'] },
    { label: 'Track 6 · Master', blurb: 'The codes, the judgment layer, the compound operator.',
      slugs: ['the-codes', 'the-judgment-layer', 'the-compound-operator'] },
  ],
  // Theatrical AI Output — the creator ladder, with the VIP Punk Rock fork.
  'Theatrical AI Output': [
    { label: 'Track 0 · Speed Run', blurb: 'Publish volume, find your voice, silence the hater.',
      slugs: ['innovator-or-hater', 'the-100-video-problem', 'find-your-voice'] },
    { label: 'Track 1 · Production Studio', blurb: 'Sound, visuals, and a complete video pipeline.',
      slugs: ['sound-design-for-youtubers', 'visual-firepower', 'the-complete-video-pipeline'] },
    { label: 'Track 2 · Content Engine', blurb: 'Ideation, an AI writing room, and batch production.',
      slugs: ['the-ideation-machine', 'ai-as-your-writing-room', 'batch-production'] },
    { label: 'Track 3 · Business', blurb: 'Packaging, growth, monetization — the sustainable creator.',
      slugs: ['packaging-that-earns-the-click', 'growth-and-monetization', 'the-sustainable-creator'] },
    { label: 'Track 4 · Advanced Production — Pro', blurb: 'Retention, multi-model orchestration, the creator’s studio.',
      slugs: ['retention-mastery', 'multi-model-orchestration', 'the-creators-studio'] },
    { label: 'Track 5 · Expand — Pro', blurb: 'Books, course products, a multi-platform empire.',
      slugs: ['the-book-you-already-made', 'course-products-for-creators', 'the-multi-platform-empire'] },
    { label: 'Track 6 · Master — Pro', blurb: 'The creator’s code, taste and judgment, the compound creator.',
      slugs: ['the-creators-code', 'taste-and-judgment', 'the-compound-creator'] },
    { label: 'Track 4 · Punk Rock AI — VIP', blurb: 'The fast fork: the manifesto, the toolkit, the zine.',
      slugs: ['the-manifesto', 'the-toolkit', 'the-zine'] },
  ],
};
